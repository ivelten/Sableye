...
Move.create!(
  name: 'absorb',
  description: 'Absorb',
  type: Type.find_by_name('Grass'),
  category: MoveCategory.find_by_name('Special'),
  power_points: 25,
  base_power: 20,
  accuracy: 100,
...
Move.create!(
  ...
  type: Type.find_by_name('Rock'),
  category: MoveCategory.find_by_name('Physical'),
  power_points: 20,
  base_power: 40,
  accuracy: 100,
...
Move.create!(
  name: 'agility',
  description: 'Agility',
  type: Type.find_by_name('Psychic'),
  category: MoveCategory.find_by_name('Other'),
  power_points: 30,
  base_power: 0,
  accuracy: 0,

...
Ability.create!(
  ...
  effect: 'When sunny, the Pokémon’s Speed doubles. ' \
...
Ability.create!(
  ...
  effect: 'During sunshine, the Pokémon’s Special Attack raises to 1.5 times ' \
          'but HP decreases by 1/8th the maximum HP every turn.'
)
